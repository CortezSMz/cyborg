	...
	public async exec(message: Message) {
		...
		if (guildLogs) {
			...
			const embed = new MessageEmbed()
				...
				.addField('ﾅ Channel', message.channel)
				.addField('ﾅ Message', `${message.content.substring(0, 1020)}`)
				.addField('ﾅ Message', `[Jump To](${message.url})`, true);
			if (attachment) embed.addField('ﾅ Attachment(s)', attachment.url);
